					...
					<fieldset>
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-lg-4 col-md-6 col-sm-8">
									<input class="form-control" id="input-text" type="text" name="title" placeholder="Isi tajuk pengumuman">
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-lg-4 col-md-6 col-sm-8">
									<input class="form-control" id="input-text" type="text" name="content" placeholder="Isi pengumuman">
								</div>
							</div>
						</div>
