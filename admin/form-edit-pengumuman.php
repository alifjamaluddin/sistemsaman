					...
					<div class="form-group-btn">
						<div class="row">
							<div class="col-lg-4 col-lg-push-2 col-md-6 col-md-push-3 col-sm-8 col-sm-push-4">
								<button class="btn btn-blue waves-button waves-light waves-effect" type="submit" name="submit">Kemaskini</button><a class="btn waves-button waves-effect" href="pengumuman.php" >Batal</a>
							</div>
						</div>
					</div>
				</form>
