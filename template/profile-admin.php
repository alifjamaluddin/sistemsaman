			...
			<div class="menu-wrap">
				<div class="menu-top">
					...
					<div class="menu-top-info">
						<a class="menu-top-user" href="javascript:void(0)"><span class="avatar pull-left"><img alt="alt text for <?php echo $_SESSION['username'] ?> avatar" src="../images/users/avatar-001.jpg"></span><?php echo $_SESSION['username'] ?></a>
					</div>
